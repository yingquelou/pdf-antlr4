...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::ObjContext *tree)
{
    if (tree)
    {
        visit(tree->Null());
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::DictContext *tree)
{
    if (tree)
    {
        auto &&vec = tree->obj();
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::ArrayContext *tree)
{
    if (tree)
    {
        visit(tree->La());
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::ObjRefContext *tree)
{
    if (tree)
    {
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::PdfContext *tree)
{
    if (tree)
    {
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::StartxrefContext *tree)
{
    if (tree)
    {
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::StrContext *tree)
{
    if (tree)
        os << tree->getText();
    return 0;
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::StreamContext *tree)
{
    if (tree)
    {
        visit(tree->Stream());
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::TrailerContext *tree)
{
    if (tree)
    {
        visit(tree->Trailer());
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::SubXrefContext *subXref)
{
    if (subXref)
    {
        visit(subXref->Int(0));
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::SubXrefEntryContext *entry)
{
    if (entry)
    {
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::XrefContext *tree)
{
    if (tree)
    {
        visit(tree->Xref());
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::XStrContext *tree)
{
    if (tree)
        os << tree->getText();
    return 0;
...
std::any antlr4::pdfFormatVisitor::visit(pdfParser::PdfObjContext *tree)
{
    if (tree)
    {
...
std::any antlr4::pdfFormatVisitor::visit(tree::ParseTree *tree)
{
    if (tree)
...
std::any antlr4::pdfFormatVisitor::visitTerminal(tree::TerminalNode *node)
{
    os << node->getText();
    return 0;
}